...
void initSimBindings(py::module& m) {
  ...
  py::class_<Simulator, Simulator::ptr>(m, "Simulator")
      ...
      .def("set_articulated_link_friction",
           ...
           "friction"_a)
      .def("get_articulated_link_angular_velocity",
           &Simulator::getArticulatedLinkAngularVelocity, "object_id"_a, "link_id"_a)
      .def("get_articulated_link_linear_velocity",
           &Simulator::getArticulatedLinkLinearVelocity, "object_id"_a, "link_id"_a)
      .def("get_articulated_link_velocity",
           &Simulator::getArticulatedLinkVelocity, "object_id"_a, "link_id"_a)
