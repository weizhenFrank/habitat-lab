...
./evalsim_gibson_noisy_rgbd.sh ${MODEL_PATH} Swormville ${NOISE_TYPE}| tee results/rect_0.15_gaussian_gibson_corl/no_noise_25_1.txt
./evalsim_gibson_noisy_rgbd.sh ${MODEL_PATH} Swormville ${NOISE_TYPE}| tee results/rect_0.15_gaussian_gibson_corl/no_noise_25_2.txt
