...
ACTIONS.VELOCITY_CONTROL.PANG_VEL_RANGE = [-30.0, 30.0]  # deg per sec
...
ACTIONS.DYNAMIC_VELOCITY_CONTROL.LIN_VEL_RANGE = [
    -0.50,
    0.50,
]  # meters per sec
ACTIONS.DYNAMIC_VELOCITY_CONTROL.HOR_VEL_RANGES = [
    -0.50,
    0.50,
]  # meters per sec
ACTIONS.DYNAMIC_VELOCITY_CONTROL.ANG_VEL_RANGE = [
    -30.0,
    30.0,
]  # meters per sec
...
ACTIONS.DYNAMIC_VELOCITY_CONTROL.TIME_STEP = 0.33  # seconds
...
_C.TASK.POINTGOAL_SENSOR.LOG_POINTGOAL = False
# -----------------------------------------------------------------------------
...
_C.TASK.POINTGOAL_WITH_NOISY_GPS_COMPASS_SENSOR.NOISE = 100
# -----------------------------------------------------------------------------
# OBJECTGOAL SENSOR
# -----------------------------------------------------------------------------
