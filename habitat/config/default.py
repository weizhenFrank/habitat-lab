...
_C.ENVIRONMENT.ITERATOR_OPTIONS.CURRICULUM = True
...
ACTIONS.VELOCITY_CONTROL.NOISE_MEAN_X = 0.0
ACTIONS.VELOCITY_CONTROL.NOISE_MEAN_Y = 0.0
# in degrees
ACTIONS.VELOCITY_CONTROL.NOISE_MEAN_T = 0.0

# var is converted to std when sampling noise
ACTIONS.VELOCITY_CONTROL.NOISE_VAR_X = 0.0
ACTIONS.VELOCITY_CONTROL.NOISE_VAR_Y = 0.0
# in degrees
ACTIONS.VELOCITY_CONTROL.NOISE_VAR_T = 0.0
...
# MultiRGBSensor
# -----------------------------------------------------------------------------
_C.SIMULATOR.L_RGB = SIMULATOR_SENSOR.clone()
_C.SIMULATOR.L_RGB.TYPE = "HabitatSimRGBSensor"
_C.SIMULATOR.L_RGB.UUID = "l_rgb"

_C.SIMULATOR.R_RGB = SIMULATOR_SENSOR.clone()
_C.SIMULATOR.R_RGB.TYPE = "HabitatSimRGBSensor"
_C.SIMULATOR.R_RGB.UUID = "r_rgb"

_C.SIMULATOR.B_RGB = SIMULATOR_SENSOR.clone()
_C.SIMULATOR.B_RGB.TYPE = "HabitatSimRGBSensor"
_C.SIMULATOR.B_RGB.UUID = "b_rgb"
