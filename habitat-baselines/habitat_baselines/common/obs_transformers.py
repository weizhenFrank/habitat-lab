...
class CenterCropper(ObservationTransformer):
    ...
    @classmethod
    def from_config(cls, config: Config):
        cc_config = config.habitat_baselines.rl.policy.obs_transforms.center_cropper
        return cls(
...
class CubeMap2Equirect(ProjectionTransformer):
    ...
    def from_config(cls, config):
        cube2eq_config = config.habitat_baselines.rl.policy.obs_transforms.cube2eq
...
class CubeMap2Fisheye(ProjectionTransformer):
    ...
    @classmethod
    def from_config(cls, config):
        cube2fish_config = config.habitat_baselines.rl.policy.obs_transforms.cube2fish
...
class Equirect2CubeMap(ProjectionTransformer):
    ...
    @classmethod
    def from_config(cls, config):
        eq2cube_config = config.habitat_baselines.rl.policy.obs_transforms.eq2cube
