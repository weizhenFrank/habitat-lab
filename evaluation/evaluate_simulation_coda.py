...
#x    assert torch.__version__ == vtorch, "Please use torch {}".format(vtorch)
    if args.noise_type == 'poisson_ilqr':
        if args.noise == 'all':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_noisy_poisson_ilqr.yaml"
            if args.gen:
                cfg_file="habitat_baselines/config/pointnav/ddppo_pointnav_lab_noisy_poisson_ilqr_gen.yaml"
        elif args.noise == 'actuation':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_actuation_ilqr.yaml"
        elif args.noise == 'sensors':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_sensors_poisson.yaml"
        elif args.noise == 'no_noise':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_no_noise.yaml"
        else:
            print('no noise specified. using all noise')
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_noisy_poisson_ilqr.yaml"
    elif args.noise_type == 'speckle_mb':
        if args.noise == 'all':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_noisy_speckle_mb.yaml"
            if args.gen:
                cfg_file="habitat_baselines/config/pointnav/ddppo_pointnav_lab_noisy_speckle_mb_gen.yaml"
        elif args.noise == 'actuation':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_actuation_mb.yaml"
        elif args.noise == 'sensors':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_sensors_speckle.yaml"
        elif args.noise == 'no_noise':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_no_noise.yaml"
        else:
            print('no noise specified. using all noise')
        ...
        if args.noise == 'all':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_noisy_gaussian_proportional.yaml"
            if args.gen:
                cfg_file="habitat_baselines/config/pointnav/ddppo_pointnav_lab_noisy_gaussian_proportional_gen.yaml"
        elif args.noise == 'actuation':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_actuation_proportional.yaml"
        elif args.noise == 'sensors':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_sensors_gaussian.yaml"
        elif args.noise == 'no_noise':
            cfg_file = "habitat_baselines/config/pointnav/ddppo_pointnav_lab_no_noise.yaml"
        else:
            print('no noise specified. using all noise')
