...
ACTIONS.DYNAMIC_VELOCITY_CONTROL.MAX_LIN_VEL_RANGE = [-0.50, 0.50]  # meters per sec
ACTIONS.DYNAMIC_VELOCITY_CONTROL.MAX_HOR_VEL_RANGE = [-0.50, 0.50]  # meters per sec
ACTIONS.DYNAMIC_VELOCITY_CONTROL.MAX_ANG_VEL_RANGE = [-17.19, 17.19]  # meters per sec
ACTIONS.DYNAMIC_VELOCITY_CONTROL.LIN_VEL_RANGES = [[-0.23, 0.23], [-0.28, 0.28], [-0.25, 0.25]]  # meters per sec
ACTIONS.DYNAMIC_VELOCITY_CONTROL.HOR_VEL_RANGES = [[-0.23, 0.23], [-0.28, 0.28], [-0.25, 0.25]]  # meters per sec
ACTIONS.DYNAMIC_VELOCITY_CONTROL.ANG_VEL_RANGES = [[-7.81, 7.81], [-9.77, 9.77], [-30, -30]]  # deg per sec
