...
def load_model(weights_path, dim_actions):
    ...
    cfg_file = '/Users/joanne/repos/habitat_spot_v2/habitat-lab/habitat_baselines/config/pointnav/ddppo_pointnav_spot.yaml'
    default_config = get_config(config_paths=cfg_file)
