...
Magnum::Vector3 Simulator::getArticulatedLinkAngularVelocity(int objectId, 
                                                            int linkId) {
  if (sceneHasPhysics(0)) {
    return physicsManager_->getArticulatedLinkAngularVelocity(objectId, linkId);
  }
  return Magnum::Vector3();
};

Magnum::Vector3 Simulator::getArticulatedLinkLinearVelocity(int objectId, 
                                                            int linkId) {
  if (sceneHasPhysics(0)) {
    return physicsManager_->getArticulatedLinkLinearVelocity(objectId, linkId);
  }
  return Magnum::Vector3();
};

std::vector<Magnum::Vector3> Simulator::getArticulatedLinkVelocity(int objectId, 
                                                            int linkId) {
  if (sceneHasPhysics(0)) {
    return physicsManager_->getArticulatedLinkVelocity(objectId, linkId);
  }
  return std::vector<Magnum::Vector3>();
};
